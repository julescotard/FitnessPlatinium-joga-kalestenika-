...
NAME_KEYS_PRIMARY = ["serviceName", "activityName", "className", "displayName", "title", "name"]
...
def _looks_like_event(d: Dict[str, Any]) -> bool:
    ...
    if not name:
        return False
    start_dt = _extract_dt(d, [
        "start", "startDate", "startDateTime", "startsAt", "dateFrom", "from", "begin", "date",
        "startUtc", "startUTC", "startDateUtc", "startDateTimeUtc", "startDateTimeUTC"
    ])
    if start_dt:
        return True
                ...
                for blob in captured_blobs:
                    for obj in _iter_json_objects(blob):
                        ...
                        end_dt = _extract_dt(obj, ["end", "endDate", "endDateTime", "endsAt", "dateTo", "to", "finish",
                                                  "endUtc", "endUTC", "endDateUtc", "endDateTimeUtc", "endDateTimeUTC"])
